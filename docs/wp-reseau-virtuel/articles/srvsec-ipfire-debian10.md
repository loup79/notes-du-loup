...
Comme pour le réseau virtuel 2017, vous allez créer et placer la VM srvsec _(IPFire)_ en entrée du réseau local ou celle-ci servira entre autres de pare-feu.
...
[Mémento 3.1](/serveur-debian10-srvdmz-creation/)
