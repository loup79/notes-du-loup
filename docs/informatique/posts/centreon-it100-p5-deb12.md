...
<figure markdown>
  ![Capture - Centreon : Statistiques de l'hôte Web sur 1 jour](../images/2026/04/centreon-hote-siteweb-statistique.webp){ width="430" }
</figure>
...
La supervision d’un site réalisée avec les Cdes Curl et Ping permettra de vérifier la disponibilité et les performances de celui-ci.
...
La partie ci-dessous s'inspire de la [docs.centreon.com](../medias/Centreon-applications-protocole-http.pdf){ target="_blank" }.
...
Remplissez l'onglet Configuration de l'hôte comme ci-dessous :

<figure markdown>
  ![Capture - Centreon : Information de base sur l'hôte Web](../images/2026/04/centreon-hote-site-web.webp){ width="580" }
  <figcaption>Centreon : Information de base sur l'hôte Web</figcaption>
</figure>

Choisissez un site dont vous connaissez l'URL _(Adresse IPv4 / FQDN)_ et le port HTTP(S) utilisés.

Pour éviter d'éventuels soucis de DNS, ajoutez ces 2 lignes dans le fichier /etc/hosts de la VM Debian de nom centreon seulement si le central de Centreon et le site Web se trouvent sur le même LAN :
...
N'oubliez pas de configurer une période de contrôle et remplissez ensuite l'onglet Notification :

<figure markdown>
  ![Capture - Centreon : Notification par e-mail pour l'hôte à Non](../images/2026/04/centreon-hote-siteweb-notification.webp){ width="580" }
...
Menu Configuration -> Services -> Services par l'hôte
...
<figure markdown>
  ![Capture - Centreon : URL type https://domaine/sous-dossier/](../images/2026/04/centreon-service-siteweb-url-sous-dossier.webp){ width="580" }
  <figcaption>Centreon : URL type https://domaine/sous-dossier/</figcaption>
</figure>

-> Onglet Notifications

Configurez une période de contrôle et remplissez ensuite l'onglet Notifications comme suit :

<figure markdown>
  ![Capture - Centreon : Notification HTTP-Response-Time à Non](../images/2026/04/centreon-service-siteweb-notifications.webp){ width="580" }
...
<figure markdown>
  ![Capture - Centreon : Notification Ping à Oui](../images/2026/04/centreon-service-ping-notifications-oui.webp){ width="580" }
...
<figure markdown>
  ![Capture - Centreon : Configuration de l'hôte Web déployée](../images/2026/04/centreon-siteweb-deploiement.webp)
...
<figure markdown>
  ![Capture - Centreon : Statistiques de l'hôte Web sur 1 jour](../images/2026/04/centreon-hote-siteweb-statistique.webp){ width="580" }
