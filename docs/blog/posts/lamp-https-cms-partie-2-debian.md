---
title: "LAMP HTTPS CMS / Debian : 2/2"
...
<figure markdown>
  ![Synoptique - Web PHP MySQL sous Debian - Mémento 8.1](../images/2026/02/web-php-mysql-2-debian-memento-8.1.webp){ width="430" }
</figure>
...
<figure markdown>
  ![Image - HTTPS : Négotiation SSL/TLS](../images/2026/02/https-negociations-ssl-tls.webp){ width="430" }
  <figcaption>HTTPS : Négotiation SSL/TLS</figcaption>
</figure>

Vous utiliserez, pour le chiffrement, l'outil [openssl](https://docs.openssl.org/master/man7/ossl-guide-introduction/){ target="_blank" } installé avec Apache.
...
#### _- Hôte virtuel et test HTTPS_{#module-ssl}
...
<figure markdown>
  ![Capture - HTTPS : Site loupvirtuel.fr sécurisé](../images/2026/02/https-1-debian.webp){ width="430" }
...
<figure markdown>
  ![Capture - HTTPS : Détail du certificat SSL pour loupvirtuel.fr](../images/2026/02/https-2-debian.webp){ width="430" }
...
!!! note "Nota"
    Remplacez php8.4 par php 8.2 si vous êtes sous Debian 12.
...
<figure markdown>
  ![Capture - Dotclear : Panneau d'administration](../images/2026/02/dotclear-administration-debian.webp){ width="430" }
...
<figure markdown>
  ![Capture - Dotclear : Page d'accueil de loupvirtuel.fr](../images/2026/02/dotclear-accueil-debian.webp){ width="430" }
...
[Mémento 9.1](../posts/sftp-debian.md){ .md-button .md-button--primary }
